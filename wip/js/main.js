        ...
        function viewportAnimation() {
            ...
            blocks.forEach(function(current) {
                ...
                if (inView && (!isAnimated)) {
                    // Check if block contains images
                    const images = current.querySelectorAll("[data-animate-el] img");
                    ...
                    if (images.length > 0 && !imagesLoaded) {
                        ...
                        })).then(() => animateBlock(current));
                    } else {
                        // No images or images already loaded
                        animateBlock(current);
                    }
                }
            });
        }

        function animateBlock(current) {
            anime({
